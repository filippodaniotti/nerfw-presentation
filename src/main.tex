...
\begin{frame}{Temporal latent embedding vector}
    ...
    \bigskip
    \begin{figure}
        \animategraphics[loop,autoplay,width=.25\textwidth]{20}{assets/gifs/waving-flag/waving-flag-}{0}{57}
    \end{figure}
    \begin{itemize}
    ...
    %     \begin{column}{.5\textwidth}
    %         \begin{figure}
    %             \animategraphics[loop,autoplay,width=.4\textwidth]{20}{assets/gifs/waving-flag/waving-flag-}{0}{57}
    %         \end{figure}
    %     \end{column}
    % \end{columns}
\end{frame}
